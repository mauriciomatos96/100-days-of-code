...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_label = Label(text=f"Score: 0", bg=THEME_COLOR, fg="white", pady=20)
        self.score_label.grid(row=0, column=1)

        self.canvas = Canvas(bg="white", width=300, height=250)
        self.quiz_text = self.canvas.create_text(150, 125, width=280, fill=THEME_COLOR, text="Here go the quiestion",
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.quiz_text, text="You have reached the end of the questions")
